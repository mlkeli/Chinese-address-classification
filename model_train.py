import os
import torch
from load_data import read_data, build_label_2_index, Data
from params import *
...
def train():
    ...
    dev_text, dev_label, max_length = read_data(dev_filename)
    ...
    # 数据迭代器
    train_data = Data(train_text, train_label, tokenizer, label2index, max_length)
    train_loader = DataLoader(train_data, batch_size=32, shuffle=False)

    dev_data = Data(dev_text, dev_label, tokenizer, label2index, max_length)
